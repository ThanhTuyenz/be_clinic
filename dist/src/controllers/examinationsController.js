...
exports.upsertExamination = upsertExamination;
const mongoose_1 = __importDefault(require("mongoose"));
const Appointment_js_1 = __importDefault(require("../models/Appointment.js"));
const Examination_js_1 = __importDefault(require("../models/Examination.js"));
function isMongoObjectId(id) {
    return typeof id === 'string' && /^[a-fA-F0-9]{24}$/.test(id);
}
async function upsertExamination(req, res) {
    try {
        ...
        let appt = await Appointment_js_1.default.findById(appointmentIdRaw).lean();
        if (!appt && isMongoObjectId(appointmentIdRaw)) {
            appt = await Appointment_js_1.default.findById(new mongoose_1.default.Types.ObjectId(appointmentIdRaw)).lean();
        }
        if (!appt) {
        ...
        const doc = await Examination_js_1.default.findOneAndUpdate({ appointmentId: appointmentIdKey }, {
            $set: {
...
//# sourceMappingURL=examinationsController.js.map