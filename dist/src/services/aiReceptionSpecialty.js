...
exports.buildReceptionSystemPrompt = buildReceptionSystemPrompt;
exports.parseChuyenKhoaJson = parseChuyenKhoaJson;
exports.callOllamaForChuyenKhoa = callOllamaForChuyenKhoa;
exports.extractChuyenKhoaFromMessage = extractChuyenKhoaFromMessage;
...
function buildReceptionSystemPrompt(specialtyNames = []) {
...
function parseChuyenKhoaJson(rawContent) {
...
async function callOllamaForChuyenKhoa({ userText, specialtyNames }) {
...
async function extractChuyenKhoaFromMessage({ userText, specialtyNames, provider = 'ollama' }) {
...
//# sourceMappingURL=aiReceptionSpecialty.js.map